#!/usr/bin/env python3
"""
Extract Chase 1873 February 2025 transactions EXACTLY as shown in the PDF.
Based on the user's guidance that pages 3-5 are all account 1873.
"""

import csv
from pathlib import Path

# Based on careful PDF analysis:
# - Page 3: Account 1873 starts (has CHECKING SUMMARY)
# - Page 4: Account 1873 (continued)
# - Page 5: Account 1873 (continued) until "CHASE TOTAL CHECKING" appears

# All transactions from pages 3-5 before account 8619 starts
chase_1873_transactions = [
    # From page 3 - All Card 0665 transactions
    ...
    # From page 4 - Continuation of 1873
    ...
    # From page 5 - Continuation until account 8619 starts
...
# Important: Based on PDF analysis, the following are NOT in account 1873:
# - Environmental AL Rf Pmt (found only on page 2, which is account 2084)
# - Online Payment transactions (found only on page 2, which is account 2084)

# Save the file
output_dir = Path("/Users/rodolfoalvarez/Documents/Better Systems AI/Nancy Bennet  - Bank Staments Automation/bank-statement-analyzer/accounts/Chase 1873/2025/monthly")
...
print(f"Extracted {len(chase_1873_transactions)} transactions for Chase 1873 February 2025")
print("\nNOTE: This extraction includes ONLY transactions found on pages 3-5")
print("Environmental payment and Online Payments are on page 2 (account 2084)")

# Calculate totals for transparency (NOT for reconciliation purposes)
...
print(f"\nFor reference only (not reconciliation):")
