#!/usr/bin/env python3
"""Fix February 2025 Chase 1873 extraction by removing incorrect deposit."""
...
# Removing the Environmental AL Rf Pmt which belongs to account 2084
chase_1873_transactions = [
    # All the same transactions except the Environmental payment
...
print(f"Removed Environmental AL Rf Pmt of $275.72")
print(f"Total transactions: {len(chase_1873_transactions)}")
